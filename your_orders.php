                    ...
                    <div class="row">
						...
						$query_res= mysqli_query($db,"select * from users_orders where u_id='".$_SESSION['user_id']."'");
												if(!mysqli_num_rows($query_res) > 0 )
														{
															echo '<td colspan="6"><center>Nu aveți nicio comandă încă!</center></td>';
														}
													else
														{			      
														 ...
														 <td data-column="Item"> <?php echo $row['title']; ?></td>
														  ...
														  <td data-column="price">$<?php echo $row['price']; ?></td>
														   ...
														   <?php 
																			...
																			{
																			?>
																	<button type="button" class="btn btn-info" style="font-weight:bold;">Expediat</button>
																		   <?php 
																			  }
                        ...
                        <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-7 left-text">
                                ...
                                <div class="social-btns">
                                    ...
                                    <div class="pull-right"><a href=email.php> <span class="text">Available on the</span> <span class="text-2">App Store</span></a> </div>
                                    </a>
