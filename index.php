 ...
 <div class="user-info">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
										  <div class="user-info">
         <p style="color: white;"><b> Bun venit, <?php echo htmlspecialchars($user_data['username']); ?>!</b></p>
    </div>
		 ...
		 <script>
        function searchFood() {
            var searchInput = document.getElementById("exampleInputAmount").value;
            if (searchInput.toLowerCase() === "pescada") {
                window.location.href = "dishes.php?res_id=48";
            } 
			else if(searchInput.toLowerCase() =="kari" ||   searchInput.toLowerCase() == "kari restaurant")
			{        window.location.href = "dishes.php?res_id=53";
			}
			
					else if(searchInput.toLowerCase() =="riyo" ||   searchInput.toLowerCase() == "riyo sushi")
			{        window.location.href = "dishes.php?res_id=54";
			}
			
			else {
                alert("Nu a fost găsit niciun rezultat pentru " + searchInput);
            }
        }
    </script>
        <!-- banner part starts -->
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <input type="text" class="form-control form-control-lg" id="exampleInputAmount" placeholder="Încearcă și bucură-te!"> 
            </div>
        </div>
        <button onclick="searchFood()" type="button" class="btn theme-btn btn-lg">Caută restaurantul tău favorit</button>
    </form>
                    </div>
                    <div class="steps">
						                       ...
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															<div class="figure-wrap bg-image" data-image-src="admin/Res_img/dishes/'.$r['img'].'">
																<div class="distance"><i class="fa fa-pin"></i>35 minute</div>
															...
															<div class="content">
																...
																<div class="price-btn-block"> <span class="price">ron'.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Adaugă în coș</a> </div>
															</div>
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	...
																	<div class="bottom-part">
																		<div class="cost"><i class="fa fa-check"></i> Min 20 ron</div>
