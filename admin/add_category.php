                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right mailbox animated zoomIn">
                                <ul>
                                    <li>
                                        <div class="drop-title">Notificari</div>
                                    </li>
                            ...
                            <div class="card-body">
                                <form action='' method='post' >
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="c_name" class="form-control" placeholder="Nume categorie">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="dashboard.php" class="btn btn-inverse">Anulare</a>
                                    </div>
                                </form>
                            </div>
                        </div>
