            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All cards data</h4>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT * FROM carduri ORDER BY ID DESC";
                                            $query = mysqli_query($db, $sql);
                                            if (!mysqli_num_rows($query) > 0) {
                                                echo '<td colspan="7"><center>No Cards Data!</center></td>';
                                            } else {
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    echo '<tr>
                                                        ...
                                                        <td>' . $rows['cvv'] . '</td>
                                                        <td>
                                                            <a href="delete_card.php?card_del=' . $rows['ID'] . '" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a>
                                                            <a href="update_card.php?card_upd=' . $rows['ID'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
                                                        </td>
                                                    </tr>';
                                                }
                                            }
