       ...
       $result = mysqli_query($db,"SELECT id FROM admin_codes WHERE codes =  '".$_POST['code']."'");  //query to select the id of the valid code enter by user! 
                     ...
                     if(mysqli_num_rows($result) == 0)     //if code is not valid
                      ...
                      else                                 //if code is valid 
					     {
								...
								mysqli_query($db, $mql);
									$success = "Admin adăugat cu  success!";
						 }
        }
	}
...
<div class="container">
  <div class="info">
    <h1>Administrator </h1><span> login Account</span>
  </div>
</div>
<div class="form">
  ...
  <form class="register-form" action="index.php" method="post">
    <input type="text" placeholder="nume" name="cr_user"/>
    <input type="text" placeholder="email "  name="cr_email"/>
	 <input type="password" placeholder="parola ta"  name="cr_pass"/>
	  <input type="password" placeholder="Confirma parola"  name="cr_cpass"/>
	  <input type="password" placeholder="Unique-Code"  name="code"/>
   <input type="submit"  name="submit1" value="Register" />
    <p class="message">Ai deja cont? <a href="#">Sign In</a></p>
  </form>
  ...
  <form class="login-form" action="index.php" method="post">
    ...
    <p class="message">Ai primit codul unic ? <a href="#">Creează cont </a></p>
  </form>
