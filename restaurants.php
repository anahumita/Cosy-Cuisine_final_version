        ...
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item active"><span>1</span><a href="restaurants.php">Alege un restaurant</a></li>
                    <li class="col-xs-12 col-sm-4 link-item"><span>2</span><a href="#">Alege-ți mâncarea preferată</a></li>
                    <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Comandă și plătește online</a></li>
                </ul>
            </div>
        </div>
        <!-- end:Top links -->
                                    ...
                                    echo ' <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
                                                            ...
                                                            <div class="entry-dscr">
                                                                ...
                                                                <ul class="list-inline">
                                                                    <li class="list-inline-item"><i class="fa fa-check"></i> Min 30 RON </li>
                                                         ...
                                                         <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
                                                                <div class="right-content bg-white">
                                                                    <div class="right-review">
                                                                        ...
                                                                        <p> <a href="review_index.php" class="btn theme-btn-dash"> Scrie o recenzie</a></p> <a href="dishes.php?res_id=' . $rows['rs_id'] . '" class="btn theme-btn-dash">Vezi Meniul</a> </div>
                                                                </div>
                                                                <!-- end:right info -->
                                                            </div>';
                                }
